"""
Trains DQN bot on crypto data.
DQN Algorithm:
https://di-engine-docs.readthedocs.io/en/latest/12_policies/dqn.html

other example:
https://github.com/opendilab/DI-engine/discussions/524
...
stocks_dqn_config = dict(
    ...
    env=dict(
        ...
        stocks_data_filename="BTC_USD_kaggle_1min",  # without file extension
...
stocks_dqn_create_config = dict(
    env=dict(
        type="my-stocks-v0",
        import_names=[
            "dizoo.gym_anytrading.envs.stocks_env",
            "av_crypto_trading.reinforcement_learning.my_stocks_env",
        ],
    ),
