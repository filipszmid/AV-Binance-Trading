...
from av_crypto_trading.core import database_api, utils
from av_crypto_trading.core.converters import (
    convert_ubwa_stream_to_master_db,
    convert_ubwa_stream_to_sql,
...
def start_coin_streaming_to_database(currency: str, end: int = -1) -> None:
    ...
    coin_stream(
        stream_name=single_crypto_stream_name(currency), end=end, database=database
    )
