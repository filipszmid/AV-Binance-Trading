...
if not test_on_live_services:
    ...
    @pytest.fixture
    def example_data_binance():
        return get_hist_data_binance(Currencies.Bitcoin.value, 20)

    @pytest.fixture
    def example_data_yahoo():
        return get_hist_data_yahoo(Companies.Tesla.value, 10)

    @pytest.fixture
    def example_data_yahoo_btc():
        return get_hist_data_yahoo(Companies.Bitcoin.value, 20)
